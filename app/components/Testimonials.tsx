...
export default function Testimonials() {
  return (
    <section className="py-12 bg-gray-900 overflow-hidden md:py-20 lg:py-24" id="testimonials">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative">
          <blockquote className="mt-10">
            <div className="max-w-3xl mx-auto text-center text-lg sm:text-xl md:text-2xl leading-9 font-medium text-white">
              <p>
            ...
            <footer className="mt-8">
              <div className="md:flex md:items-center md:justify-center">
                ...
                <div className="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                  <div className="text-base font-medium text-white">Alex Rodriguez</div>

                  <svg className="hidden md:block mx-1 h-5 w-5 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M11 0h3L9 20H6l5-20z" />
                  </svg>

                  <div className="text-base font-medium text-gray-400">Forex Trader, 3 years experience</div>
                </div>
              </div>
            </footer>
          </blockquote>
