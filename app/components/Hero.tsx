        ...
        <div className="pt-10 pb-8 lg:pt-16 lg:pb-14">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div className="lg:w-1/2 animate-fadeInUp">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl tracking-tight font-extrabold text-white">
                <span className="block xl:inline">{heroText}</span>
              </h1>
              <p className="mt-3 max-w-md mx-auto text-base sm:text-lg md:text-xl text-gray-300 lg:mx-0">
              ...
              <div className="mt-8 sm:flex sm:justify-center lg:justify-start">
                <div className="rounded-md shadow animate-pulse">
                  <Link href="https://discord.com/invite/globalgains" passHref>
                    <Button
                      size="lg"
                      className="w-full sm:w-auto px-8 py-3 bg-green-500 text-white hover:bg-green-600 transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
                    >
                      Join Discord
                    </Button>
                  </Link>
